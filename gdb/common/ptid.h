...
/* Make a ptid given the necessary PID, LWP, TID, and TARGET
   components.  */
...
/* Make a new ptid from just a pid and a target.  This ptid is usually
   used to represent a whole process, including all its
   lwps/threads.  */
